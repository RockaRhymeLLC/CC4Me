...
echo "  Scheduler"
echo "  ────────────────────────────────────────"
check_json_array /tasks "Scheduler tasks" 10
...
check_json_array /logs/modules "Log modules" 3
...
echo "  Integrations"
echo "  ────────────────────────────────────────"
check GET /calendar "Calendar" '"events"'
check GET /voice/status "Voice status" '"connected"'

echo ""
echo "  Dashboard"
echo "  ────────────────────────────────────────"
check GET /ops "Ops dashboard" '<html'
check GET / "Public index" '<html'
