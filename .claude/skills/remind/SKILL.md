...
2. **Plist**: `~/Library/LaunchAgents/com.bmo.reminder.<id>.plist` — launchd job that fires at the scheduled time
...
# Clean up
launchctl bootout gui/$(id -u) ~/Library/LaunchAgents/com.bmo.reminder.ID.plist 2>/dev/null
rm -f ~/Library/LaunchAgents/com.bmo.reminder.ID.plist
rm -f "$0"
```
...
<dict>
    <key>Label</key>
    <string>com.bmo.reminder.ID</string>
    <key>ProgramArguments</key>
    <array>
        <string>/bin/bash</string>
        <string>/Users/bmo/CC4Me-BMO/scripts/reminders/remind-ID.sh</string>
    </array>
    ...
    <string>/Users/bmo/CC4Me-BMO/logs/reminder-ID.log</string>
...
8. **Load the plist**: `launchctl bootstrap gui/$(id -u) ~/Library/LaunchAgents/com.bmo.reminder.ID.plist`
9. **Verify**: `launchctl list | grep reminder.ID`
10. **Confirm**: Tell the user when the reminder will fire

### Listing Reminders

1. Glob for `~/Library/LaunchAgents/com.bmo.reminder.*.plist`
...
1. Unload: `launchctl bootout gui/$(id -u) ~/Library/LaunchAgents/com.bmo.reminder.ID.plist`
2. Delete plist: `rm ~/Library/LaunchAgents/com.bmo.reminder.ID.plist`
...
| launchd plists | `~/Library/LaunchAgents/com.bmo.reminder.<id>.plist` |
...
- Chat ID defaults to Dave's (`7629737488`). Override by specifying a different recipient in the message.
