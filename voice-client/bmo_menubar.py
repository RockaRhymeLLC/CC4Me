...
ICONS = {
    "idle":       os.path.join(SCRIPT_DIR, "icon_idle.png"),
    "listening":  os.path.join(SCRIPT_DIR, "icon_active.png"),
    "processing": os.path.join(SCRIPT_DIR, "icon_processing.png"),
    "speaking":   os.path.join(SCRIPT_DIR, "icon_speaking.png"),
    "stopped":    os.path.join(SCRIPT_DIR, "icon_idle.png"),
    "error":      os.path.join(SCRIPT_DIR, "icon_idle.png"),
}
...
class BMOVoiceApp(rumps.App):
    ...
    def __init__(self):
        # Start with the idle icon (outline BMO)
    ...
    def _set_icon_for_state(self, state_name):
        ...
        if os.path.exists(icon_path):
            ...
            self.icon = None
            self.title = "BMO" if state_name == "idle" else f"BMO [{state_name}]"
