#!/usr/bin/env python3
"""Generate BMO menu bar icons — outline (idle) and filled (active)."""
...
def draw_bmo(draw, filled=False):
    """Draw a tiny BMO character.

    BMO is a rectangular game console with:
    ...
    # Colors
    if filled:
        # Active: BMO's signature teal/green
